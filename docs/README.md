...
| [ability/mixer.md](ability/mixer.md) | `xi ability recipe` / `compose` / `publish` / `catalog`: build a new ability from pieces of retail ones, install it in ROM10, and the viewer's Ability Mixer mode that drives them |
